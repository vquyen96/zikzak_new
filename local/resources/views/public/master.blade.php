...
<body>
	...
	{{--<!-- Start of cgroup Zendesk Widget script -->--}}
	{{--<script id="ze-snippet" src="https://static.zdassets.com/ekr/snippet.js?key=ff86e6fb-1b35-4be1-87ce-512d1e2f98d7"> </script>--}}
	{{--<!-- End of cgroup Zendesk Widget script -->--}}
	...
	{{--<div class="fb-livechat">--}}
		...
		{{--<div class="fb-widget">--}}
			...
			{{--<div class="fb-page" data-href="https://www.facebook.com/zikzakcoworkingspace" data-tabs="messages" data-width="360"--}}
				 {{--data-height="400" data-small-header="true" data-hide-cover="true" data-show-facepile="false"></div>--}}
			{{--<div id="fb-root"></div>--}}
		{{--</div>--}}
		{{--<a href="{{ str_replace('https://www.facebook.com','https://m.me', 'https://www.facebook.com/zikzakcoworkingspace') }}" title="Gửi tin nhắn cho chúng tôi qua Facebook" class="ctrlq fb-button">--}}
