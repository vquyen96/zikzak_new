				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<input required="" type="text" class="form-control"  placeholder="Enter title" name="news_name" value="{{$news->news_name}}">
						</div>
						<div class="form-group">
							<label class="bold">Summary</label>
							<textarea required="" class="form-control" name="news_summary">{!!$news->news_summary!!}</textarea>
							<p class="help-block italic">Phần chữ đậm đầu bài viết</p>
						</div>
						<div class="form-group">
							<label class="bold">Tag:</label>
							<input type="text" id="tokenfield" name="tag" required="" class="form-control" value="{{$news->tag}}">
				...
				<div class="box box-primary">
					<div class="box-body">
						<div class="form-group">
							...
							<input type="file" id="file" name="news_image[]" style="display: none" onchange="changeImg(this)">
							<img id="add-image" src="../public/news/image/{{ $news->news_image }}">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="box box-primary">
					<div class="box-body">
						<div class="form-group">
							...
							<textarea required="" class="form-control" name="news_content">{!!$news->news_content!!}</textarea>
						</div>
					</div>
